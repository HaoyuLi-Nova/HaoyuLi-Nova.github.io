...
- *2026.04*: &nbsp;📝 *PsycheAgents* and *PsyCare* are under review at **Nature Mental Health**; *Rectified Flow for Electronic Health Record Synthesis* is under submission—see Publications below.
...
- **PsycheAgents: A Multi-Modal Agentic Framework for Psychiatric Differential Diagnosis** — Haoyu Li (1st author), et al. **Nature Mental Health** (*under review*).
...
- **Rectified Flow for Electronic Health Record Synthesis** — Haoyu Li (1st author), et al. (Manuscript in submission to **npj Digital Medicine**).
...
- **MARS Lab, Wuhan University** — *Research Assistant* · Apr. 2025 – Present · Wuhan, China · Advisor: Prof. Mang Ye  
  - **Confidential anonymized manuscript:** A paper is currently under anonymized peer review; this site does **not** list its title or venue pending conference policy.
  - **PsycheAgents:** Architected a multi-modal agentic framework for differential diagnosis; designed a hierarchical reasoning pipeline inspired by clinical consultation, improving diagnostic interpretability and reasoning depth.  
