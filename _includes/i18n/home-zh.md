...
我的志向是在**三维计算机视觉**、**多模态学习**、**生成式人工智能**与**具身智能**的交叉领域长期深耕。我希望研究**从场景几何与多模态表征，到生成式世界模型，再到语言驱动的机器人执行**的一体化方法，使 AI 不仅能**看懂并生成**可信的视觉世界，也能在真实数据与硬件平台上形成**可验证、可部署的闭环能力**。这是我计划长期投入的研究路径。
...
- *2026.04*：*S3Mamba-Pan* 被 **IEEE TGRS** 接收，DOI：[10.1109/TGRS.2026.3686021](https://doi.org/10.1109/TGRS.2026.3686021)。
- *2025.10*：获评武汉大学 **优秀学生干部**、**优秀学生** 等荣誉。
